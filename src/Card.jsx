  ...
  return (
    <><div style={{ background: "white", marginTop:"20px" }} >
        ...
        <FaShoppingCart style={{ color: 'white', fontSize: "20px" }} />
                        ...
                        <div className='btn-wrapper' style={{ display: 'flex', justifyContent: 'space-between' }}>
                          <div className='hover-btn' style={{ display: cardHover[card.id] ? 'flex' : 'none' }}>
                            ...
                            <AiOutlineHeart
                                style={{ marginRight: '20px', color: isHeartClicked ? 'red' : 'black' }}
      ...
      />
                              ...
                              <a href='https://www.instagram.com/cafecoffeeday/?hl=en'><FaInstagram style={{ marginRight: '20px' }} /></a>
                              <a href='https://www.facebook.com/cafecoffeeday/'><FaFacebook style={{ marginRight: '20px' }} /></a>
                            </div>
                          </div>
